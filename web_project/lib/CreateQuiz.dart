...
class _QuizCreatorPageState extends State<QuizCreatorPage> {
  ...
  void addQuizData() {
    ...
    _databaseRef
        .child('Robophone/MahmoudTesting/quizzes/' + generatedPin + '/quizID')
        .update({
      'quizID': generatedPin,
    });
    _databaseRef
        .child('Robophone/MahmoudTesting/quizzes/' +
            generatedPin +
            '/questions/' +
    ...
    _databaseRef
        .child(
            'Robophone/MahmoudTesting/quizzes/' + generatedPin + '/quizDetails')
        .update({
